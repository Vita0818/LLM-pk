...
**版本：Scoring v1.2 + Practical Adjustment v1.1**
...
当两个套餐的月费与额度完全同比例增长时，它们的有效成本相同，不重复建配置。
例如 100 美元档的额度是 20 美元档的 5 倍时，两者均由 20 美元基础档代表；
200 美元 20× 档因额度相对基础档增长 20 倍，成本效率不同，继续独立保留。
